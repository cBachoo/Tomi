...
module.exports = {
    ...
    execute(client, message, args, temp, rawAuto){
        ...
        const query = "/api.php?action=query&format=json&prop=revisions%7Cimageinfo&rvprop=content&rvslots=main&rvsection=1&iiprop=url&titles=";
        const titles = args + "|File:" + args + ".png";
        const imgtitles = 
        console.log(titles);
