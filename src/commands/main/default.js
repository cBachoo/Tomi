...
module.exports = {
    ...
    execute(client, message, args, temp, rawAuto) {
        const baseurl = "https://wizardoflegend.gamepedia.com/api.php?";
        const titles = args;
        const query = `action=query&format=json&prop=imageinfo%7Crevisions&titles=File:${titles}.png|${titles}&iiprop=url&iilimit=5&rvprop=content&rvslots=main&rvsection=1`
